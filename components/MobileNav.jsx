...
function MobileNav({ links }) {
  return (
    <Disclosure as="nav" className="bg-orange-500/80 backdrop-blur text-white sm:hidden">
				{({ open }) => (
					<>
						<DisclosureButton>
						...
						>
							<DisclosurePanel static>
								<div id="navbar" className="flex flex-col sm:flex-row justify-center p-4 gap-4 items-center">
									...
									<LocaleSwitcher className="w-fit m-0 text-white bg-white/50 hover:bg-black/80 hover:text-white px-3 py-2 rounded-md text-sm font-medium border-2 border-transparent focus-visible:border-purple-600 focus-visible:outline-none transition"></LocaleSwitcher>
								</div>
							</DisclosurePanel>
						</Transition>
					</>
